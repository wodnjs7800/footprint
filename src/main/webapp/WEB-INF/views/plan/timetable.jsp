...
<body onload="initTmap();">
	<div style="padding-left: 100px; padding-bottom: 10px;">
		<table>
			<tr>
				<td style="padding: 3px"><button>조회순</button></td>
				<td style="padding: 3px"><button>리뷰순</button></td>
				<td style="padding: 3px"><button>평점순</button></td>
			</tr>
		</table>
	</div>
	<div
		style="overflow: auto; float: left; padding-left: 100px; width: 400px; height: 850px">
		<table>
			<%
				for (int i = 0; i < 20; i++) {
			%>
			<tr>
				<td rowspan='2' style="padding: 10px"><a href=# onclick="">
						<img style="float: left; width: 150px; height: 150px">
				</a></td>
				<td style="width: 210px; height: 30px;">식당 이름</td>
			</tr>
			<tr>
				<td style="width: 210px; height: 30px;">별점</td>
			</tr>
			<%
				}
			%>
