								...
								<div class="service-block">
									...
									<div class="service-content">
										<div class="testimonial-content" style="padding: 10px">
											<h4 class="hiddenx"> ${dto.bname } <button type="button" class="btn btn-outline-success my-2 my-sm-0" style="margin-left: 5px;height:30px" onclick="deleteC('${dto.cartno}')">X</button>
											</h4>																												
										</div>	
									</div>
