	...
	<div class="space-medium">
		<div class="container" style="width: 800px;">
			...
			<div style="margin-top: 40px;">
                ...
                <button class="btn btn-outline-success my-2 my-sm-0" style="margin-left: 160px;height:40px" onclick="createf()">저장하기</button>
            </div>
			<hr>
			<!--comments start-->
  ...
  <output  for="star-input"><b id="point">0</b>점</output>
					...
					<form>
						<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
								<div class="form-group">
									<button id="modalRegisterBtn" name="modalRegisterBtn"
										type="button" class="btn btn-primary btn-sm">등록</button>
								</div>
							</div>
						</div>
					</form>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/food_breply.js"></script>

	<!-- 페이지 로딩시 댓글 목록 처리-->
	<!-- jstl는 internal javascript에서 사용가능 -->
	<script type="text/javascript">
  var foodno = "${dto.foodno}"; 
  var sno = "${sno}";
  var eno = "${eno}";
 <!-- 댓글용 paging, 게시판 검색 -->
  var nPage = "${nPage}";
  ...
  var id = "${id}";
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/food_replyprocess.js"></script>
</body>
</html>