...
<body>
					...
					<div class="post-block">
						<div class="post-img">
							<img src="/travel/storage/${dto.fname}"
								...
								class="img-responsive" onload="fitImage(this)">
						</div>
					</div>
				</div>
  ...
  <output  for="star-input"><b id="point">0</b>점</output>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/travel_breply.js"></script>

	<!-- 페이지 로딩시 댓글 목록 처리-->
	<!-- jstl는 internal javascript에서 사용가능 -->
	<script type="text/javascript">
  var travelno = "${dto.travelno}"; 
  var sno = "${sno}";
  var eno = "${eno}";
 <!-- 댓글용 paging, 게시판 검색 -->
  var nPage = "${nPage}";
  ...
  var id = "${id}"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/travel_replyprocess.js"></script>
</body>
</html>