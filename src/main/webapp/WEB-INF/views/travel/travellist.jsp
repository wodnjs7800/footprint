...
<head>
<title>여행지 등록 요청</title>
<meta charset="utf-8">
<link href="${pageContext.request.contextPath }/css/heon.css"
	rel="stylesheet">
<script type="text/javascript">
	function travelUpdate(travelno) {
		var url = "travelupdate";
...
<body>
	...
	<div class="bg-default space-medium">
        <div class="container">
        <h1 align="center" style="margin-bottom:60px">여행지 등록 요청 페이지</h1>
						...
						<c:otherwise>
							<c:forEach var="dto" items="${list}" >
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 expand_img"
									onclick='location.href="javascript:travelUpdate(${dto.travelno} )"'>
